...
#
# Thin launcher only. It finds kterm and opens the admin front end inside it so
# the on-screen keyboard is available.
#
# kterm's -e takes ONE argument that it splits itself, and it cannot cope with a
# path containing spaces -- which is why the real script lives at a space-free
# path under extensions/ rather than here in documents/.
